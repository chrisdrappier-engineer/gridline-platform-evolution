...
The dispatcher is an internal Gridline user responsible for intake, triage,
assignment, and queue coordination across customers and customer sites.
...
As a dispatcher, I can create a service request from a selected site so I can
