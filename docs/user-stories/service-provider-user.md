...
The service provider user is a provider-side user responsible for responding to
assigned service requests, documenting work performed, and identifying follow-up
needs.

## Stories

### View Assigned Provider Requests
