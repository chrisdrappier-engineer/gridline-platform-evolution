module RbacSeedData
  ...
  PERMISSIONS = [
    ...
    ["service_request_feedbacks", "read", "Read service request feedback", "View service request ratings and completion feedback."],
    ["service_request_feedbacks", "create", "Create service request feedback", "Submit service request ratings and completion feedback."],
    ["service_request_feedbacks", "update", "Update service request feedback", "Update service request ratings and completion feedback."],
  ...
  ROLE_PERMISSIONS = {
    "dispatcher" => [
      ...
      ["service_request_feedbacks", "read"],
      ["service_request_feedbacks", "create"],
      ["service_request_feedbacks", "update"],
